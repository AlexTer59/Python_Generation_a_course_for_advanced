...
# строки sentence длиною меньше 4 символов. Результат вывести на одной строке (в нижнем регистре) в алфавитном
...
words = {i.lower().strip('.,;:-?!()') for i in sentence.split() if len(i.strip('.,;:-?!()')) < 4}
print(*sorted(words))
