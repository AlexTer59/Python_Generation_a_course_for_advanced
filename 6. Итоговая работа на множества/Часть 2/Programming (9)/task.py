...
# информатику соответственно. Далее идут m+n строк — фамилии учеников, изучающих математику и информатику,
...
all_students = {input() for i in range(n + m)}
res = (n + m - ((n + m - len(all_students)) * 2))
if res > 0:
    print(res)
else:
    print("NO")
