...
# этого файла в файл output.txt в виде нумерованного списка, где перед каждой строкой стоит ее номер, символ ) и
...
with open('input.txt', 'r', encoding='utf-8') as file1, open('output.txt', 'w', encoding='utf-8') as file2:
    for i, value in enumerate(file1.readlines(), start=1):
        print(f'{i})', value.rstrip(), file=file2)
