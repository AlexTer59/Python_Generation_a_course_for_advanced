...
# этого файла. Она должна возвращать список словарей, интерпретируя первую строку как имена ключей,
...
#
# [{'name': 'George', 'address': '4312 Abbey Road', 'age': '22'}, {'name': 'John', 'address': '54 Love Ave',
# 'age': '21'}]
...
def read_csv():
    ...
    with open('data.csv', 'r', encoding='utf-8') as file:
        ...
        for line in file.readlines():
            list_of_dicts.append({key.rstrip(): value.rstrip() for key, value in zip(keys.split(','), line.split(','))})
